...
project = 'PCVS'
copyright = "2020-{}, Commissariat a l'Energie Atomique et aux Energies Alternatives".format(datetime.now().date().year)
author = 'Julien Adam'
...
version = pcvs.__version__
# The full version, including alpha/beta/rc tags.
release = pcvs.__version__
...
# pixels large.
#
html_favicon = "_static/pcvs_favicon.ico"
